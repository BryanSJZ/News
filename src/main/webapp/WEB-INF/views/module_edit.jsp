                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="${pageContext.request.contextPath}/module/update">
                                      <input hidden name="id" value="${module.id}">
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">栏目名称</label>
                                          <div class="col-lg-10">
                                              <input class="form-control" id="cname" name="module" value="${module.module}" minlength="5" type="text" />
                                          </div>
                                      </div>
                                      <div class="form-group">
