                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="${pageContext.request.contextPath}/news/update">
                                      <input hidden name="id" value="${news.id}">
                                      <div class="form-group">
                                          <label for="cname" class="control-label col-lg-2">新闻名称 <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control" id="cname" name="title" minlength="5" type="text" required value="${news.title}"/>
                                          </div>
                                      </div>
                                      <div class="form-group">
                                          <label for="cemail" class="control-label col-lg-2">作者 <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control" id="cemail" type="text" name="author" required value="${news.author}" />
                                          </div>
                                      </div>
                                      <div class="form-group">
                                          <div class="form-group">
                                              ...
                                              <div class="col-lg-10">
                                                  <select class="form-control m-bot15" name="type">
                                                      <c:forEach items="${list}" var="m">
                                                          <option value="${m.id}"
                                                                  <c:if test="${news.type == m.id}" >selected</c:if>
                                                          >
                                                                  ${m.module}
                                                          </option>
                                                      </c:forEach>
