...
<head>
  ...
  <body class="login-img3-body">
    ...
    <div class="container">
      ...
      <form class="login-form" action="${pageContext.request.contextPath}/user/register" method="post">
        <div class="login-wrap">
            ...
            <a class="btn btn-info btn-lg btn-block" href="${pageContext.request.contextPath}/user/index">返回登录</a>
        </div>
      </form>
    </div>
